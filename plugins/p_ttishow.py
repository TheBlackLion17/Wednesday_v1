...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🎀ᴜᴩᴅᴀᴛᴇꜱ🎀', url='https://t.me/AgsModsOG')
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
        await message.reply_text(
            text=f"<b>›› ᴛʜᴀɴᴋꜱ ᴛᴏ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴩ. {message.chat.title} ❣️\n›› ᴅᴏɴ'ᴛ ꜰᴏʀɢᴇᴛ ᴛᴏ ᴍᴀᴋᴇ ᴍᴇ ᴀᴅɪᴍɴ.\n›› ɪꜱ ᴀɴʏ ᴅᴏᴜʙᴛ'ꜱ ᴀʙᴏᴜᴛ ᴜꜱɪɴɢ ᴍᴇ ᴄʟɪᴄᴋ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ.. 💥💥.</b>",
            reply_markup=reply_markup)
    else:
        ...
        if settings["welcome"]:
            for u in message.new_chat_members:
                ...
                video="https://envs.sh/Fo.mp4",                                               
                                                 ...
                                                 reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('➡️ɢʀᴏᴜᴘ ʀᴜʟᴇs⬅️', url='https://t.me/AgsModsOG') ] ] )
                )
